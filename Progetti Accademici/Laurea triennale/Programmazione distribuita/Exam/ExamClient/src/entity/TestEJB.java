...
@NamedQueries({
    ...
    @NamedQuery(name="AGGIORNA_VOTO", query="UPDATE TestEJB e SET e.voto=:voto WHERE e.id=:id"),
    @NamedQuery(name="CANCELLA_PER_ID", query="DELETE FROM TestEJB e WHERE e.id=:id")
})
